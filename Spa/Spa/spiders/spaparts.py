...
class Spapart(scrapy.Spider):
    ...
    def parse_category(self, response):
        ...
        category_item['breadcrumbs'] =  [a.attrib.get('href') for a in response.css("div.col-sm-9 ol li small strong a")]
    ...
    def parse_product(self, response):
        ...
        item['breadcrumbs'] = [a.attrib.get('href') for a in response.css("div.col-sm-9 ol li small strong a")]
        ...
        item['image_urls'] = [f"{'https://www.spapartsnordic.se/'}{img.attrib.get('src')}" for img in response.css("div.image-wrapper a img.img-responsive")]
